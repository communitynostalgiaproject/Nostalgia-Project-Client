...
const Mary = require('../../assets/Mary_MacMillan.png');
const Summer = require('../../assets/Summer_LaPointe.png');
const Mukunthg = require('../../assets/Mukunthg.png');
const David = require('../../assets/David_White.png');
const Joan = require('../../assets/Joan_Joseph.png');
const Andrew = require('../../assets/Andrew_Lee.png');
